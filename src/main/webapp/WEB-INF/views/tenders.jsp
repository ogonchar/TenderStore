			...
			<div>
				<c:forEach items="${tendersfiling}" var="tendersfiling">  
					<div class="btn-group col-md-12">
						...
						<button type="button" class="btn btn2-wdh" onclick = "location.href = '/TenderStore1/tender/one/${tendersfiling.idTenderZakupki}'">${tendersfiling.idCompanyRecepient}<br><span class="lower">Company ID(INN)</span></button>
			...
			<p class="divider">.</p>
				<c:forEach items="${tendersconsideration}" var="tendersconsideration">
					<div class="btn-group col-md-12">
						...
						<button type="button" class="btn btn2-wdh" onclick = "location.href = '/TenderStore1/tender/one/${tendersconsideration.idTenderZakupki}'">${tendersconsideration.idCompanyRecepient}<br><span class="lower">Company ID(INN)</span></button>
			...
			<p class="divider">.</p>
				<c:forEach items="${tenderscomplited}" var="tenderscomplited">
					<div class="btn-group col-md-12">
						...
						<button type="button" class="btn btn2-wdh" onclick = "location.href = '/TenderStore1/tender/one/${tenderscomplited.idTenderZakupki}'">${tenderscomplited.idCompanyRecepient}<br><span class="lower">Company ID(INN)</span></button>
